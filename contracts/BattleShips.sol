...
// File: github/Neca-development/zkBattleShip/contracts/BattleShips.sol
...
contract BattleShips {
    ...
    function joinRoom(uint256 _roomId) public {
        ...
        emit MatchWasStarted(_roomId, session.roundNumber, msg.sender);
    }
    ...
    /*----------------------------------------EVENTS---------------------------------------------------------*/
    event RoomCreated(uint256 _roomId, address sender );
    event Moved(uint256 _roomId, address sender);
    event MatchWasStarted(uint256 _roomId, uint16 roundNumber, address sender);
